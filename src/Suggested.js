    ...
    <div className="suggested">
      ...
      <div className="footer">
        ...
        <a href="https://www.instagram.com/bbkivines_/">
          <Button size="small" className="footer_follow">
            Follow
          </Button>
        </a>
      </div>
      ...
      <div className="footer">
        ...
        <a href="https://www.instagram.com/sahidkapoor4/">
          <Button size="small" color="primary" className="footer_follow">
            Follow
          </Button>
        </a>
      </div>
      ...
      <div className="footer">
        ...
        <a href="https://www.instagram.com/cristiano/">
          <Button size="small" color="priamry" className="footer_follow">
            Follow
          </Button>
        </a>
      </div>
